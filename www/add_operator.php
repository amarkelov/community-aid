...
if ($clean['submit']) {
	if ($clean['operatorid']) {
		...
		$sql = 'INSERT INTO operators (loginname,fullname,saltypwd,addedby,isAdmin)
				VALUES ("' . $clean['loginname'] . '","' . $clean['fullname'] . 
				'",SHA1("' . $clean['password'] . getTheSalt() . '"),"' 
				. $clean['operatorid'] . '","' . $clean['isAdmin'] . '")';
	...
	if ( $clean['operatorid']) {
		print '<div align="left">
			...
			<tr><td>Administrator: </td><td><input type="checkbox" name="isAdmin" size="5" maxlength="5"></td>
			<td><<<< Check the checkbox if you want to give the operator administrator privileges</td></tr>
			<tr><td><input name="submit" type="submit" value="Add Operator" /></td></tr>
